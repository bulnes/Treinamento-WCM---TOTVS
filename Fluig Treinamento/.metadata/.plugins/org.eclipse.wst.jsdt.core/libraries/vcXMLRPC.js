...
*/
Object.prototype.getDatasetValues = function(nome, filtro){return [];};
...
/**
 * Determina que a coluna criada será do tipo STRING
 * @memberOf DatasetFieldType
 * @since   fluig 1.5.5
 * @see    http://www.totvs.com.br  
 */
...
/**
 * Objeto que contém os valores dos tipos de Constraint. Usado para criar constraints para a fun��o <code>getDataset</code>.
...
/**
 * Retorna um Array com  os datasets dispon�veis. <b><u>Usar no HTML de qualquer fichário</u></b>.<br>
 *<u>O arquivo vcXMLRPC.js precisa ser declarado</u><br>
 *&lt;script&gt; type="text/javascript" src="/webdesk/vcXMLRPC.js"&gt;&lt;/script&gt;
 * @memberOf DatasetFactory
 * @returns {Array} Array o nome dos datasets dispon�veis
 * @since   ByYou ECM 3.0.16
 * @see    http://www.totvs.com.br    
 */
...
/**
 * Retorna um Objeto representando uma constraint. Usado para criar constraints para a fun��o <code>getDataset</code>.  <b><u>Usar no HTML de qualquer fichário</u></b>.<br>
 *<u>O arquivo vcXMLRPC.js precisa ser declarado</u><br>
 *&lt;script&gt; type="text/javascript" src="/webdesk/vcXMLRPC.js"&gt;&lt;/script&gt;
 *<pre>
 *Exemplo:
...
/**
 * Objeto que possibilita a cria��o de datasets customizados.
